...
var RegistroAutomotor = /** @class */ (function () {
    function RegistroAutomotor(lectorArchivos) {
    ...
    RegistroAutomotor.prototype.darAltaVehiculo = function (input) {
        switch (input) {
            case 1:
                ...
                break;
            case 2:
                this.vehiculos.push(new moto_1.Moto(readlineSync.question("(1) Ingrese la marca: "), readlineSync.questionInt("(2) Ingrese el modelo: "), readlineSync.question("(3) Ingrese el color: "), readlineSync.questionInt("(4) Ingrese la velocidad maxima: ")));
                break;
            case 3:
...
var registroAutomotor = new RegistroAutomotor(lectorArchivos);
